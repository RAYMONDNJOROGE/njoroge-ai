...
def ask():
    ...
    # Construct the full conversation for context
    contents = [
        types.Content(role=entry["role"], parts=[types.Part.from_text(entry["text"])])
        for entry in chat_history
    ]

    # Define assistant behavior and configuration
    config = types.GenerateContentConfig(
        ...
        system_instruction=[
            types.Part.from_text(
                text=(
                    "I am Njoroge A.I., a helpful assistant that helps you in your learning. "
                    "When asked your name, always respond with: "
                    "'I am Njoroge A.I., a helpful assistant that helps you in your A.I needs straight outa Nairobi, Kenya.' "
